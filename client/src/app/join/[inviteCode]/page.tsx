...
export default function JoinRoomPage() {
  ...
  const handleJoin = () => {
    ...
    joinRoom(inviteCode, {
      ...
      onError: (error) => {
        ...
        const message = axiosError?.response?.data?.message || error.message || 'Failed to join room'
        if (message === 'User is already a member of the room') {
  ...
  const isMember =
    ...
    roomWithStatus.membershipStatus === 'MEMBER' ||
    roomWithStatus.membershipStatus === 'OWNER'
